...
var ftconfigs = {
   ...
   defaultAlbumArtUrl: "/img/discoball.png", // url of an image to use for tracks with no album art. should be a square and at least 500x500 px for best results.
   roomInfoUrl: "https://music.fuzzyrobotdiscobear.com/", // Change what the "?" button at the top of the page links to. This can be any URL
